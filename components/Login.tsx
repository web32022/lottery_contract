    ...
    <div className='bg-[#091B18] min-h-screen flex flex-col items-center justify-center text-center'>
        <div className='flex flex-col items-center mb-10'>
            <img
             ...
             <p className='text-white text-xs text-center mt-3 font-extrabold'>Our Platform Is Totally Free From Human Interaction And Runs Decentralized On The Blockchain</p>
